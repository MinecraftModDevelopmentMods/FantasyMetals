...
public class VillagerTrades extends cyano.basemetals.init.VillagerTrades {
	...
	public static void init() {
		...
		final int size = fantasymetals.init.Materials.getAllMetals().size();
		...
		fantasymetals.init.Items.getItemsByMetal().entrySet().stream()
		...
		for(final MetalMaterial m : fantasymetals.init.Materials.getAllMetals()) {
