...
public abstract class Items {
	...
	public static void init() {
		...
		classSortingValues.put(fantasymetals.items.ItemMetalIngot.class, ++ss * 10000);
		classSortingValues.put(ItemMetalNugget.class, ++ss * 10000);
		classSortingValues.put(ItemMetalPowder.class, ++ss * 10000);
		classSortingValues.put(fantasymetals.items.ItemMetalBlend.class, classSortingValues.get(ItemMetalPowder.class));
