...
public class TinkersConstructPlugin {
	...
	public static void init() {
		...
		if(Loader.isModLoaded(TCONSTRUCT_MODID)) {
			...
			final Material template = new Material("template", 0xFFC5C8C1);

			registerFluid(Fluids.fluidTemplate, true);
//			registerTinkerMaterial(template, Fluids.fluidTemplate, (int) (235 * d), 5.33f * s, 3.80f * a, 1.15f, 17, 117, 1, false, true);
